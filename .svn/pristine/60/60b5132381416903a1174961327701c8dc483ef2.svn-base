 ...
 * @LastEditTime: 2020-03-20 13:40:15
 -->

<template>
  <div class="jbr-info" v-show="isVisible" :class="{'disabled':isDisabled}">
    ...
    <div class="jbr-info-content">
      <el-table ref="jbrTable" :data="tableData" highlight-current-row tooltip-effect="dark" border
        ...
        <el-table-column label="操作" align="center" width="140" fixed="right" v-if='!isDisabled'>
