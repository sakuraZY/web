<template>
  <div class='ygdy-box'>
    <checkData ref="checkBDC" :baseInfo='baseInfo' @setDisalbed='setDisalbed'></checkData>
...
import { saveYGDY } from '@/apis/nres/ygdy';
...
export default {
  ...
  methods: {
    ...mapMutations('ygdy', { setMessJson: 'SET_MESSAGEJSON' }),
    ...mapMutations('ygdy', { setNodeName: 'SET_NODENAME' }),
