              ...
              <div class="stepwrap">
               ...
               <div v-if="stepNum===2" key="2">
                ...
                <el-row  v-if="arrflowstep.includes(1)" v-show="stepNum === 1" key="1">
                    <el-col :span="21">
                      <ygdy ref="children" @btnDisabled='btnDisabled' @funcNext="handleNext"></ygdy>
                    </el-col>
                    <el-col :span="3">
...
import { submitUrlYGDY } from '@/apis/nres/ygdy';
...
export default {
  ...
  data() {
    return {
      ...
      indexs: 0,
      infoJson: {
        messJson: ['ygdy', 'MESSAGEJSON'],
        nodeName: ['ygdy', 'NODENAME'],
        submitUrl: submitUrlYGDY,
        parentPnode: 'ygdy',
      },
      isDisabled: true,
    };
  ...
  computed: {
    ...mapState('ygdy', { arrflowstep: state => state.ARRFLOWSTEP }),
  },
  methods: {
    ...mapMutations('ygdy', {
      GO_NEXT: 'GO_NEXT',
