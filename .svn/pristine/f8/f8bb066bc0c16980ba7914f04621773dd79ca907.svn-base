              ...
              <div class="stepwrap">
               ...
               <div v-if="stepNum===2" key="2">
                ...
                <el-row  v-if="arrflowstep.includes(1)" v-show="stepNum === 1" key="1">
                    <el-col :span="21">
                      <ygjygdy ref="children" @btnDisabled='btnDisabled'
                      @funcNext="handleNext"></ygjygdy>
                    </el-col>
                    <el-col :span="3">
...
import { submitUrlYGYGDY } from '@/apis/nres/ygdy';
...
export default {
  ...
  data() {
    return {
      ...
      indexs: 0,
      infoJson: {
        messJson: ['ygjygdy', 'MESSAGEJSON'],
        nodeName: ['ygjygdy', 'NODENAME'],
  ...
  computed: {
    ...mapState('ygjygdy', { arrflowstep: state => state.ARRFLOWSTEP }),
  },
  methods: {
    ...mapMutations('ygjygdy', {
      GO_NEXT: 'GO_NEXT',
