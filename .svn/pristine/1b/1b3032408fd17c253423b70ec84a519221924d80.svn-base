<!--
 * @Descripttion: 二手房转移 步骤2
 * @version: 1.0
 * @Author: 胡威
 * @Date: 2020-03-04 13:41:55
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2020-03-19 14:48:02
 -->
<template>
  <div class='form-message-box'>
   ...
   <div class="testinfo">
      <el-form
          ...
          <el-row :gutter="50">
            <el-col :span="8">
              <el-form-item label="不动产证" prop="zh">
                <el-input v-model="testForm.zh" placeholder="请输入编号"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="4">
              <el-form-item label="原权利人姓名" prop="qlrmc">
                <el-input v-model="testForm.qlrmc" placeholder="请输入姓名"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
        ...
        <el-table
          ...
          >
            <template v-slot="scope">
              <el-button type="text"
              size="small" @click="addFamily(scope)">编辑家庭成员</el-button>
              <el-button @click="handleClick(scope.row)" type="text"
              size="small">人脸验证</el-button>
              <el-button type="text"
              size="small" @click="handleEdit(scope)">编辑</el-button>
              <el-button type="text"
    ...
    <div class="bot_btns">
      <el-button plain @click="handlerStorage" class="butBorder">暂存</el-button>
      <el-button type="info"  v-if="!isTest">下一步</el-button>
      <el-button type="primary" @click="handlerUp" v-else>下一步</el-button>
    </div>
...
import { ESZYSave } from '@/apis/nres/zxsq';
...
import ejectTable from '@/components/realReg/ysfzy/ejectTable.vue';
...
export default {
  ...
  methods: {
    ...
    ...mapMutations('eszy', { setMessJson: 'SET_MESSAGEJSON' }),
    ...mapMutations('eszy', { setNodeName: 'SET_NODENAME' }),
    handlerTestRset() {
    ...
    handlerTest() {
      this.$refs.testForm.validate((valid) => {
        if (valid) {
          const options = Object.assign(this.testForm, {
            nodeName: this.nodeName,
            ywlx: 'cqzh',
            isDY: '3',
          });
          getBDCXX(options).then((testData) => {
            if (testData.code === 0) {
              if (testData.resData.bdcdylists && testData.resData.qlrxx) {
                this.isTest = 1;
                this.userData = [];
                this.infoData = testData.resData.qlrxx.qlr || [];
                // testData.resData.qlrxx.ywr || [];
    ...
    getOptions(messageSave) {
      const personMessage = JSON.parse(sessionStorage.eszyMessage);
