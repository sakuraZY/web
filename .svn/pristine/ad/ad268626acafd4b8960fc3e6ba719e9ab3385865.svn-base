              ...
              <div class="stepwrap">
               ...
               <div v-if="stepNum===2" key="2">
                ...
                <el-row  v-if="arrflowstep.includes(1)" v-show="stepNum === 1" key="1">
                    <el-col :span="21">
                      <yszydy ref="children" @btnDisabled='btnDisabled'
                      @funcNext="handleNext"></yszydy>
                    </el-col>
                    <el-col :span="3">
...
import { submitUrlYSZYDY } from '@/apis/nres/ygdy';
...
export default {
  ...
  data() {
    return {
      ...
      indexs: 0,
      infoJson: {
        messJson: ['yszydy', 'MESSAGEJSON'],
        nodeName: ['yszydy', 'NODENAME'],
        submitUrl: submitUrlYSZYDY,
        parentPnode: 'yszydy',
      },
      isDisabled: true,
    };
  ...
  computed: {
    ...mapState('yszydy', { arrflowstep: state => state.ARRFLOWSTEP }),
  },
  methods: {
    ...mapMutations('yszydy', {
      GO_NEXT: 'GO_NEXT',
