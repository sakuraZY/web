 ...
 * @LastEditTime: 2020-03-18 16:16:47
 -->
  ...
  <div class="menu-connect">
    <div class="menu-connect-operatebar">
      ...
      <div class="btn-group">
        ...
        >
          <icon-svg iconClass="import" className="import-icon"></icon-svg>
          导入
        </el-button>
        <el-button
          size="medium"
        ...
        >
          <icon-svg iconClass="export" className="export-icon"></icon-svg>
          导出
        </el-button>
      </div>
    </div>
    ...
    >
      ...
      <template slot="footer">
        <el-button type="primary" size="medium" @click="exportMenuFile">
          <icon-svg iconClass="export" className="export-icon"></icon-svg>
          导出
        </el-button>
        <el-button plain size="medium" @click="closeExportMenuDialog">
