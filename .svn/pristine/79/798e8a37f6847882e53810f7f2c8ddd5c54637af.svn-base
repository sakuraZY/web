<template>
  <div class="form-message-box"  v-show="isVisable">
    ...
    <div id="dyqrDiv" ref="dyqrDiv" class="userinfo">
       <div class="info-head">
...
export default {
  ...
  computed: {
    ...
    ...mapState('ygjygdy', { datainfo: state => state.INFO }),
    ...mapState('ygjygdy', { bdc: state => state.BDC }),
    dyrDataFormat() {
      const dyr = this.formatData(this.dyrData);
      return dyr;
    },
    ywrDataFormat() {
      const ywr = this.formatData(this.ywrData);
      return ywr;
    },
    dyqrDataFormat() {
