 ...
 * @LastEditTime: 2020-03-19 14:23:51
 -->
<template>
    ...
    :visible.sync="htVisible" width="80%"  top="10vh">
      <div style="text-align:center;">
        ...
        <div class="diabtns">
          ...
          <el-button plain @click="htCancel" class="butBorder">取消</el-button>
        </div>
      </div>
    </el-dialog>
  </div>
...
export default {
  ...
  methods: {
    ...
    getOptions(messageSave) {
      const personMessage = JSON.parse(sessionStorage.personMessage);
      return Object.assign(messageSave, {
        ...
        WW_XWBL: {
          ...
          SFYSQBYZ: personMessage.sfgy, // 申请登记的不动产为单独所有还是共有
          SFWFSRF: personMessage.sfwh, // 婚姻登记是否未婚
        },
        qlrxx: {
          qlr: this.userData,
          ywr: this.infoData,
