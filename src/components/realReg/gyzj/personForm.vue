        ...
        <el-row :gutter="20">
          <el-col :md="12">
            <el-form-item label="联系电话:" prop="dh">
              <el-input v-model.trim="info.dh" placeholder="请输入联系电话"></el-input>
            </el-form-item>
          </el-col>
          <el-col :md="12">
            <el-form-item label="法人代表名称:" prop="frdbrxm">
              <el-input v-model.trim="info.frdbrxm" placeholder="请输入法人代表名称"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :md="12">
            <el-form-item label="法人代表证件类型:" prop="frdbzjlx">
               <el-select v-model="info.frdbzjlx" placeholder="请选择"
               style="width:100%">
                    <el-option
                      v-for="item in zjlxlist"
                      :key="item.name"
          ...
          <el-col :md="12">
            <el-form-item label="法人代表证件号码:" prop="frdbzjh">
              <el-input v-model.trim="info.frdbzjh" placeholder="请输入证件号码"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :md="12">
            <el-form-item
              ...
              prop="frdbdhhm"
            >
              <el-input v-model.trim="info.frdbdhhm" placeholder="请输入联系电话"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
