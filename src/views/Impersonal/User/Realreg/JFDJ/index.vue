 ...
 * @Description: 解封登记业务
 * @Author: wangjiayu
 * @Date: 2020-03-13 11:36:03
 * @LastEditors: wangjiayu
 * @LastEditTime: 2020-03-19 11:28:41
 -->
...
import jfdj from '@/components/realReg/jfdj';
...
import { submitUrlJFDJ } from '@/apis/nres/zxtj';
...
export default {
  ...
  data() {
    return {
      ...
      infoJson: { // 业务流程相关数据
        messJson: ['jfdj', 'MESSAGEJSON'],
        nodeName: ['jfdj', 'NODENAME'],
        submitUrl: submitUrlJFDJ,
        parentPnode: 'jfdj',
      },
    };
  },
  computed: {
    // 当前业务渲染过的步骤
    ...mapState('jfdj', { arrFlowStep: state => state.ARRFLOWSTEP }),
  },
  methods: {
    // 设置状态方法
    ...mapMutations('jfdj', {
    ...
    setDisabled(isDisabled) {
      ...
      if (isDisabled) {
        ...
        this.menulist = ['不动产数据检验', '解封清单', '解封信息', '法院经办人信息'];
      }
    },
    // 上一页
    handlePrev() {
