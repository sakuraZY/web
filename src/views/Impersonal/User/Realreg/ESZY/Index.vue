 ...
 * @version: 1.0
 * @Author: huwei
 * @Date: 2020-03-20 12:04:40
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2020-03-20 15:41:37
 -->
<template>
  <mainBox ref="mbox">
    <!-- 主要内容  -->
        ...
        <div class="flex-main">
          ...
          <div class="main-fill">
            <el-row  v-show="stepNum === 1">
              <el-col :span="21">
                <query-eszy ref="children" @func="menuTrans" @funcNext="handleNext">
                </query-eszy>
              </el-col>
              <el-col :span="3">
...
import QueryEszy from '@/components/realReg/eszy';
