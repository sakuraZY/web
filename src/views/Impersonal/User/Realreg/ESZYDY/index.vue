      ...
      <div class="flex-content">
        <div class="flex-main">
          ...
          <el-row v-if="arrflowstep.includes(1)" v-show="stepNum === 1" key="1">
            <el-col :span="21">
              <eszydy ref="children" @btnDisabled='btnDisabled' @funcNext="handleNext"></eszydy>
            </el-col>
            <el-col :span="3">
...
export default {
  ...
  data() {
    return {
      ...
      indexs: 0,
      infoJson: {
        messJson: ['eszydy', 'MESSAGEJSON'],
        nodeName: ['eszydy', 'NODENAME'],
        submitUrl: submitUrlESZYDY,
        parentPnode: 'eszydy',
      },
      isDisabled: true,
    };
  ...
  computed: {
    ...mapState('eszydy', { arrflowstep: state => state.ARRFLOWSTEP }),
  },
  methods: {
    ...mapMutations('eszydy', {
      GO_NEXT: 'GO_NEXT',
    ...
    btnDisabled(bdisabled) {
      ...
      if (bdisabled) {
        ...
        this.menulist = ['不动产数据检验', '权利人信息', '抵押权人信息', '义务人信息', '不动产权信息', '第三方债务人信息', '抵押信息'];
      }
    },
  },
  mounted() {
