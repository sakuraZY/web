        ...
        <div class="flex-main">
          ...
          <div class="main-fill">
            ...
            <el-row v-if="arrflowstep.includes(2)" v-show="stepNum === 2">
             ...
             <query-upload v-if="arrflowstep.includes(3)" v-show="stepNum === 3"
             ref="children" @func="nextStep" :infoJson="infoJson"
             ></query-upload>
             <query-success v-if="arrflowstep.includes(4)" v-show="stepNum === 4"
             ref="children" :infoJson="infoJson"
             ></query-success>
          </div>
        </div>
      </div>
      ...
      <div class="footflex" v-if="stepNum >1&&stepNum<4">
        <div class="foot-btn">
          <ul class="btnList">
            ...
            <li>
              <el-button type="primary" @click="handlerUp"
              v-if="stepNum === 2">下一步</el-button>
              <el-button type="primary" @click="handlerUp"
              v-if="stepNum === 3">提交</el-button>
            </li>
          </ul>
        </div>
      </div>
