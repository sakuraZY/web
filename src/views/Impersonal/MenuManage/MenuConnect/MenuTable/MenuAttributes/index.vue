 ...
 * @LastEditTime: 2020-03-21 09:39:11
 -->
...
<template>
  <div class="menu-detail-container">
    ...
    >
      ...
      <el-form-item label="路由路径" prop="menuLinkurl">
        <el-input type="textarea" v-model="menuAttrForm.menuLinkurl" placeholder="路由路径"
          resize="none" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="路由名称" prop="menuLinkname">
        <el-input type="textarea" v-model="menuAttrForm.menuLinkname" placeholder="路由名称"
          resize="none" autocomplete="off"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getCurrentMenuData() {
      ...
      if (this.operateType === 'update' && this.menuDetail) {
        const {
          menuText,
          menuLinkurl,
          menuLinkname,
